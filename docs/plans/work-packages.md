...
- [ ] **Milestone M1** and its eight steps are defined in
      [implementation-plan.md](implementation-plan.md), with S7A, which is
      what has to land before the purge, and the running order after it.
