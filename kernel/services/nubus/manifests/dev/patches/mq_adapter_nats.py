...
# is no longer captured by the stream -> NoStreamResponseError.
...
# Fixed: was "ldap-producer-subject" in upstream 0.66.3 image — out of sync with
# backends/nats_mq.py LdapQueue which uses message_subject = self.name = "ldap-producer".
...
class NatsMessageQueue:
    ...
    async def connect(self):
        ...
        By default, it fails after a maximum of 10 seconds because of a 2 second
        connect timout * 5 reconnect attempts.
        """
